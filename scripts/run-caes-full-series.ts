...
const runs = [
	{
		label: 'raw-caes',
		args: ['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram', 'code-switch-ca-es', '--runs', '5']
	},
	{
		label: 'corrected-caes',
		args: ['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram-corrected', 'code-switch-ca-es', '--runs', '5']
	},
	{
		label: 'raw-corts',
		args: ['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram', 'code-switch-ca-es-corts', '--runs', '5']
	},
	{
		label: 'corrected-corts',
		args: ['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram-corrected', 'code-switch-ca-es-corts', '--runs', '5']
	},
	{
		label: 'raw-parlament',
