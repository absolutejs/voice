...
const commands = [
	{
		...
		proc: Bun.spawn(
			['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram', 'multi-speaker-clean'],
			{
				cwd: import.meta.dir + '/..',
				env: sharedEnv,
				stdout: 'inherit',
	...
	},
	{
		...
		proc: Bun.spawn(
			['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram', 'multi-speaker-noisy'],
			{
				cwd: import.meta.dir + '/..',
				env: sharedEnv,
				stdout: 'inherit',
	...
	},
	{
		...
		proc: Bun.spawn(
			['bun', 'run', './scripts/benchmark-stt.ts', 'deepgram-corrected', 'multi-speaker-noisy'],
			{
				cwd: import.meta.dir + '/..',
				env: sharedEnv,
				stdout: 'inherit',
