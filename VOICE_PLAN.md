...
- Browser WebRTC stats readiness gate. Status: `@absolutejs/media@0.0.1-beta.3` exposes `buildMediaWebRTCStatsReport(...)`; `@absolutejs/voice@0.0.22-beta.318` consumes it as `Browser media transport`; the example proof pack passes with `.voice-runtime/proof-pack/2026-04-30T08-42-46.753Z`.
