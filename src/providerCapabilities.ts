...
export type VoiceProviderCapabilitySummary<
	TProvider extends string = string
...
export type VoiceProviderCapabilityReport<
	TProvider extends string = string
> = {
...
export type VoiceProviderCapabilityOptions<
	TProvider extends string = string
...
>(
	...
	const capabilities = definitions.map((definition) => {
		...
		const status: VoiceProviderCapabilitySummary<TProvider>['status'] = !configured
			? 'unconfigured'
			: selected
				? 'selected'
