...
const resolveTableName = (input: {
  ...
  const prefix = normalizeTableNameSegment(
...
> => {
  ...
  return {
    ...
    auditDeliveries:
      createSQLiteAuditSinkDeliveryStoreWithDatabase<TAuditDelivery>(
        database,
        resolveTableName({
          fallback: "audit_deliveries",
          options,
    ...
    traceDeliveries:
      createSQLiteTraceSinkDeliveryStoreWithDatabase<TTraceDelivery>(
        database,
        resolveTableName({
          fallback: "trace_deliveries",
          options,
