...
export type VoiceRoutingStatusWidgetOptions =
...
export const mountVoiceRoutingStatus = (
  ...
  const render = () => {
    element.innerHTML = renderVoiceRoutingStatusHTML(
      store.getSnapshot(),
      options,
    );
  };
