...
const createSurface = (
	id: 'audit' | 'trace',
	summary: VoiceDeliveryRuntimeSummary['audit'] | VoiceDeliveryRuntimeSummary['trace']
...
export const renderVoiceDeliveryRuntimeHTML = (
	...
	const surfaces = model.surfaces
		.map(
			(surface) => `<li class="absolute-voice-delivery-runtime__surface absolute-voice-delivery-runtime__surface--${escapeHtml(surface.status)}">
