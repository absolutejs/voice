...
export class VoiceCampaignDialerProofService {
	connect(
		...
		const reportSignal = signal<VoiceCampaignDialerProofReport | undefined>(undefined);
		const statusSignal = signal<VoiceCampaignDialerProofStatus | undefined>(undefined);
