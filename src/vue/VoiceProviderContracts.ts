      ...
      return h(
        ...
        [
          h("header", { class: "absolute-voice-provider-contracts__header" }, [
            h(
              "span",
              { class: "absolute-voice-provider-contracts__eyebrow" },
              model.title,
            ),
            h(
              "strong",
              { class: "absolute-voice-provider-contracts__label" },
              model.label,
            ),
          ]),
          h(
            "p",
            { class: "absolute-voice-provider-contracts__description" },
            model.description,
          ),
          model.rows.length
            ? h(
          ...
          model.error
            ? h(
                "p",
                { class: "absolute-voice-provider-contracts__error" },
                model.error,
              )
            : null,
        ],
