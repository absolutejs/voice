...
const resolveTwilioCallSid = async <
	...
	TResult
>(
	resolver: VoiceTwilioRedirectHandoffAdapterOptions<TContext, TSession, TResult>['callSid'],
	input: VoiceHandoffInput<TContext, TSession, TResult>
) => {
...
export const createVoiceTwilioRedirectHandoffAdapter = <
	...
	TResult = unknown
>(
	options: VoiceTwilioRedirectHandoffAdapterOptions<TContext, TSession, TResult>
): VoiceHandoffAdapter<TContext, TSession, TResult> => ({
